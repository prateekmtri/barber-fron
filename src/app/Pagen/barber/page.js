  ...
  return (
    <div>
      ...
      <div className='pb-20 pt-20 pl-5 lg:pl-24 '>
        ...
        <div className='flex absolute lg:inset-x-24 inset-y-[335px] lg:inset-y-[372px] opacity-0 hover:opacity-100 gap-2 duration-500 delay-75 bg-opacity-0 hover:bg-opacity-65  hover:bg-black h-96 w-80 pt-36 pl-20'>
      ...
      <div className='pb-20 pt-20 pl-5 '>
        ...
        <div className='flex absolute inset-x-[20px] lg:inset-x-[436px] inset-y-[976px] lg:inset-y-[372px] opacity-0 hover:opacity-100 gap-2 duration-500 delay-75 bg-opacity-0 hover:bg-opacity-65  hover:bg-black h-96 w-80 pt-36 pl-20'>
          <Image src={Facebook} className='h-12 w-12  bg-white hover:bg-red-700 '></Image>
          <Image src={Twitter} className='h-12 w-12 bg-white hover:bg-red-700'></Image>
          <Image src={Insta} className='h-12 w-12 bg-white hover:bg-red-700'></Image>
      ...
      <div className='pb-20 pt-20 pl-5 '>
        ...
        <div className='flex absolute inset-x-[800] inset-y-[1616px] lg:inset-y-[372px] opacity-0 hover:opacity-100 gap-2 duration-500 delay-75 bg-opacity-0 hover:bg-opacity-65  hover:bg-black h-96 w-80 pt-36 pl-20'>
          <Image src={Facebook} className='h-12 w-12  bg-white hover:bg-red-700 '></Image>
          <Image src={Twitter} className='h-12 w-12 bg-white hover:bg-red-700'></Image>
          <Image src={Insta} className='h-12 w-12 bg-white hover:bg-red-700'></Image>
      ...
      <div className='pb-20 pt-20 pl-5 '>
        ...
        <div className='flex absolute inset-x-[1200] inset-y-[2256px] lg:inset-y-[372px] opacity-0 hover:opacity-100 gap-2 duration-500 delay-75 bg-opacity-0 hover:bg-opacity-65  hover:bg-black h-96 w-80 pt-36 pl-20'>
          <Image src={Facebook} className='h-12 w-12  bg-white hover:bg-red-700 '></Image>
          <Image src={Twitter} className='h-12 w-12 bg-white hover:bg-red-700'></Image>
          <Image src={Insta} className='h-12 w-12 bg-white hover:bg-red-700'></Image>
