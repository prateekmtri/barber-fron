    ...
    <div id="contact" className="w-full md:h-[900px] bg-black text-white">
      ...
      <div className="pt-20 pl-[10px] lg:pl-[400px] pb-28">
        <form ref={form} onSubmit={sendEmail} className=" h-[850px] lg:h-[750px] w-[350px] lg:w-[800px] bg-[#191c24] p-3 lg:p-14">
            ...
            <input type="text" placeholder="Enter Your name" name="to_name" className="text-white w-[330px]  h-20 p-5 bg-[#191c24] border-slate-800 border-4 " />

          </div>
          <div className="">
           
            <input type="email" placeholder="Enter Your Email" name="from_name" className="text-white  w-[330px] h-20 p-5  bg-[#191c24] border-slate-800 border-4" />
          </div>
            </div>
          ...
          <div className=" pt-16 pb-10">
            ...
            <textarea name="message" placeholder="Message" className="text-white w-[330px] lg:w-[700px]  h-24 pt-2 pl-4 bg-[#191c24] border-4 border-slate-800 text-2xl font-thin" />
          </div>
